...
def compute_lineshape_func_3rd(corr_func,kbT,sampling_rate_in_fs,max_t,steps):
    ...
    print 'Correlation step length'
    print step_length_corr

    sample_rate=sampling_rate_in_fs*math.pi*2.0*const.hbar_in_eVfs

    print 'Stupid test: Max and min values of correlation function'
    print corr_func[0,0,0],corr_func[corr_func.shape[0]-1,corr_func.shape[0]-1,0]
