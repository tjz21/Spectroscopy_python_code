...
class MD_cumulant(TestCase):
    def runTest(self):
        ...
        tester.compare_linear_spectra(self, 'MD_cumulant_spectrum.dat')
        tester.compare_linear_spectra(self, 'MD_resonance_raman.dat')
        tester.compare_linear_spectra(self, 'MD_spectral_density.dat')
...
class MD_ensemble(TestCase):
    def runTest(self):
        ...
        tester.compare_linear_spectra(self, 'MD_ensemble_spectrum.dat')
